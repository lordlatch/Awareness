...
![](images/clipboard-845457062.png){width="50%"}
...
![](images/clipboard-2431021561.jpeg){width="50%"}

Each of these are branches on the tree which is why the perennial doctrines are universal and keep popping up in every system. Such as: Love thy Neighbor as Thyself. (I'll come back to this!)
...
![](images/clipboard-504409474.jpeg){width="75%"}
...
While you can't exactly tell the future with astrology (except when to do agricultural tasks), humans are imprinted by the angles (angels) of various celestial objects.

Humanity is One and their differences are merely the result of the angle of light as it enters them. Like a vast complex crystal looks different when angle of the light changes.

![](images/clipboard-4208939338.png)

Each person is a facet (face) on a great gem. If any one of them was missing, it would be hollow. Each face provides a perspective.

The cycles abide and I am right there in the middle (ab(i)de).

Om is a word that is considered to be the universe.

O is the circle or cycle or observer( O, I am Observing ).
...
Vowels are the breath or spirit and consonants are the matter that matters and are constant.

Consonants slow or stop the breath.

The slower the vibration, the more solid the object

and thus, matter is spoken into reality.

It was always there but a delineation is made by the application of change in its frequency.
